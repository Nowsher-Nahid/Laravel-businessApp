...
@section('title', 'Aim Direct | Add Sub-category')
@section('content')
	...
	<form action="{{ route('sub_category.store') }}" method="POST" enctype="multipart/form-data">
		@csrf
		<div class="row add-sub-category">
			<div class="col-xl-6">
				<div class="dashboard-box margin-top-0">
                    ...
                    <div class="content with-padding padding-bottom-10">
                        <div class="submit-field">
                            <h5>Category</h5>
                            <select class="with-border" name="category_id" required>
			...
			<div class="col-xl-12">
				<button class="button ripple-effect big margin-top-30"><i class="icon-feather-plus"></i> Save Sub-category</button>
			</div>
