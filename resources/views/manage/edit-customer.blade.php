...
@section('title', 'Aim Direct | Edit Customer')
@section('content')
		...
		<div class="row">
			<div class="col-xl-6">
				<div class="dashboard-box margin-top-0">
					<div class="headline">
						<h3><i class="icon-feather-folder-plus"></i> Customer Form</h3>
					</div>
			...
			<div class="col-xl-12">
				<a href="#" class="button ripple-effect big margin-top-30"><i class="icon-feather-plus"></i> Update Customer</a>
			</div>
